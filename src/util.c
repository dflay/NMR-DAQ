...
// miscellaneous paths
const std::string constants_t::ANL_SG382_LO_IDN   = "s/n001399";  // LO IDN 
const std::string constants_t::ANL_SG382_PI2_IDN  = "s/n002351";  // PI/2 IDN
const std::string constants_t::FNAL_SG382_LO_IDN  = "s/n000000";  // LO IDN 
const std::string constants_t::FNAL_SG382_PI2_IDN = "s/n000001";  // PI/2 IDN 
...
// hardware limits 
const double constants_t::PI2_POWER_LIMIT         = 3.5; // in Watts
